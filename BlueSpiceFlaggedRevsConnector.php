...
class FlaggedRevsConnector extends Extension {
	...
	const REVIEW_TYPE_FLAGGING = 'flagging';
	...
	public static function onRegistration() {
		...
		// Override review process types
		$GLOBALS['bsgReviewProcessTypes'] = [
			static::REVIEW_TYPE_FLAGGING => 'bs-flaggedrevsconnector-review-type-flagging'
		];

		$GLOBALS['bsgReviewProcessDefaultType'] = static::REVIEW_TYPE_FLAGGING;
