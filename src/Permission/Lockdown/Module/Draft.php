...
class Draft extends \BlueSpice\Permission\Lockdown\Module {
	...
	protected function __construct( Config $config, IContextSource $context,
		MediaWikiServices $services, LoadBalancer $loadBalancer, array $allowedRequestActions,
		array $frNamespaces, array $allowedGroups ) {
	...
	public static function getInstance( Config $config, IContextSource $context,
		MediaWikiServices $services, LoadBalancer $loadBalancer = null,
